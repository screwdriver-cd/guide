...
| K8S_MAX_BUILD_TIMEOUT | 120        | Default max build timeout for all builds in this cluster (in minutes) |
...
| K8S_VM_MAX_BUILD_TIMEOUT | 120     | Default max build timeout for all builds in this cluster (in minutes) |
